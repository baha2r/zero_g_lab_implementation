...
def plot_action_topic(messages):
    ...
    plt.title('Position Action', fontsize=22)
    plt.xlabel('Timesteps', fontsize=18)
    plt.ylabel('x0.01 m', fontsize=18)
    ...
    plt.axhline(0, color='black', linestyle='--', linewidth=.1)
    plt.title('Orientation Action', fontsize=22)
    plt.xlabel('Timesteps', fontsize=18)
    plt.ylabel('x0.1 rad', fontsize=18)
    plt.tick_params(axis='both', which='major', labelsize=10)
    plt.legend()
    plt.tight_layout()
...
def plot_pose_topic_w_ref(messages, ref):
    ...
    plt.title('Orientation (quat)', fontsize=22)
    plt.xlabel('Timesteps', fontsize=18)
    plt.ylabel('Orientation', fontsize=18)
    plt.tick_params(axis='both', which='major', labelsize=10)
    gripper_line = mlines.Line2D([], [], color='black', linestyle='-', label='Gripper')
    ...
    plt.title('Orientation (euler)', fontsize=22)
    plt.xlabel('Timesteps', fontsize=18)
    plt.ylabel('Orientation', fontsize=18)
    plt.tick_params(axis='both', which='major', labelsize=10)
    gripper_line = mlines.Line2D([], [], color='black', linestyle='-', label='Gripper')
...
def plot_distance_and_orientation(distances, orientation_differences, timestamps):
    ...
    plt.axhline(0, color='black', linestyle='--', linewidth=.1)
    plt.title('Closest Points', fontsize=22)
    plt.xlabel('Timesteps', fontsize=18)
    plt.ylabel('meter', fontsize=18)
    plt.tick_params(axis='both', which='major', labelsize=10)
    # plt.legend()
    ...
    plt.axhline(0, color='black', linestyle='--', linewidth=.1)
    plt.title('Quaternion Differences', fontsize=22)
    plt.xlabel('Timesteps', fontsize=18)
